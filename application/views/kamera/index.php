<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Kamera</h1>
	<ol class="breadcrumb">
	...
	<div class="col-xl-12 col-lg-7 mb-4">
		<div class="card">
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				<h6 class="m-0 font-weight-bold text-primary">List Kamera</h6>
...
<?php $this->load->view('Kamera/add');?>
<?php $this->load->view('Kamera/edit');?>
<script>
	$(function(){
		$("#table").DataTable()
	})
...
<script>
	$(document).on("click", ".btn_edit", function () {
		...
		$.ajax({
			url : "<?= base_url('Kamera/find_by_id/')?>" + id, 
			method : "POST", 
			success : function (e) {
